        ...
        if ( $latest_gallery->have_posts() ):
            ...
            if ( ! empty( $galleries ) ) {
                foreach ( $galleries as $gallery ) {
                    ...
                    ?>
                        <div class="flex w-full sm:w-[313px] lg:h-[247px] p-[60px] md:p-[56px] xl:p-[66px] flex-col justify-center items-center gap-[10px] border-[5px] dark:bg-gray-300 border-[#FFE4D5] bg-white">';
                        <img src="<?php esc_url( $img_url ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" class="w-full h-full object-contain">
                        </div>
                        <?php
                    }
                }
            ...
            <p>
                <?php echo esc_html__( "No gallery founds now", "smokewings" ); ?>
            </p>
        <?php
            endif;
        ?>
