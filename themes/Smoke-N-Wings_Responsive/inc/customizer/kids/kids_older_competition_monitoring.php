...
function smokewings_kids_older_competition_monitoring_customizer( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'kids_older_competition_monitoring_section',
        array(
    ...
    $wp_customize->add_setting(
        'kids_older_competition_monitoring_title',
        array(
    ...
    // Button Text
    $wp_customize->add_setting(
        'kids_older_competition_monitoring_button_text',
        array(
    ...
    // Image
    $wp_customize->add_setting(
        'kids_older_competition_monitoring_image',
        array(
            'default'           => THEME_DIR_URI . '/assets/images/oldercompetiotionmonitoring.png',
