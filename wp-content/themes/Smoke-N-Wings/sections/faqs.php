<section class="w-[1440px] flex gap-[19.50px] py-10 ">
    <!-- left image -->
        ...
        <!-- svg -->
         <div class="relative z-20">
           ...
           <img src="<?php echo get_template_directory_uri(); ?>/assets/images/faqs.png"
                     alt="hero image"
                     class="w-[594px] h-[495px] object-cover z-20">
         </div>
        
     </div>
     
    <!-- right faqs -->
 <div class=" bg-white w-[626px] rounded-xl shadow-lg p-6">
    ...
    <?php
      ...
      if ( $faqs->have_posts() ):
        ...
        while ( $faqs->have_posts() ): $faqs->the_post();
          $count++;
          // ২ নাম্বার আইটেম ডিফল্টভাবে খোলা থাকবে
          $is_open = ($count === 2);
          $extra_border = ($count === 1) ? 'border-t' : '';
    ?>
      <div class="faq-item border-b <?php echo $extra_border; ?> border-[#F8B895]">
        <button class="faq-btn w-full flex justify-between items-center py-4 text-left text-lg font-medium text-gray-800 focus:outline-none">
        ...
        <div class="faq-content <?php echo $is_open ? '' : 'hidden'; ?> text-gray-600 text-base leading-relaxed pb-4">
          <?php the_content(); ?>
        </div>
      </div>
    <?php
