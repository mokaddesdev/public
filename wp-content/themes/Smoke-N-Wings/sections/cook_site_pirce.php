...
<section class="pt-12 pb-6 w-[1440px] px-[126px] flex flex-col gap-12">
<?php
/**
...
if ( $hav_query->have_posts() ) :
  ...
  <div class="flex flex-col justify-between p-12 w-full">
    ...
    <div class="flex justify-between items-start -mt-1.5">
      <h2 class="text-black font-bebas text-[34px] font-normal leading-[120%] not-italic">
        <?php echo esc_html( get_the_title() ); ?> 
      </h2>
      <?php $price = get_post_meta( get_the_ID(), '_price', true );
            if ( ! empty( $price ) ) :?>
      <p class="text-[#16396F] text-right font-bebas text-[44px] font-normal leading-[120%] not-italic">
    ...
    <h3 class="text-[#7C7C7C] font-jost text-[18px] font-normal leading-[120%] not-italic mt-0 w-[470px]">
