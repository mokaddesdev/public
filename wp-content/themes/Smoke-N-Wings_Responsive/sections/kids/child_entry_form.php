...
<section class="relative w-full max-w-[1440px] -mb-10 mt-6 sm:mt-8 md:mt-12 lg:mt-14 xl:mt-20 2xl:mt-[100px]"
    style="background: linear-gradient(0deg,rgba(0,0,0,0.50) 0%,rgba(0,0,0,0.50) 100%), 
           url('<?php echo esc_url($bg_image); ?>') center/cover no-repeat;">
